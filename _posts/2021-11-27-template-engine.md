...
Oferece mais recursos ao HTML. Sendo bem mais dinâmico temos:
- Estruturas de repetição.
- Estruturas condicionais.
- Exibir no seu arquivo HTML dados que vêm do <em>back-end</em>. Exemplo.: uma variável do JavaScript pode ser acessada e assim exibir seu conteúdo no HTML.

<em>Foto: temos no topo os dados (data) e a template, no meio a template engine, e por fim a página de resultado (result documents)</em>.
...
📜️ MIT.
É disponível para C++, Java, JavaScript, PHP...
<h5>Outras template engine</h5>
Mais algumas...
<pre>doT
Dust
ECT
