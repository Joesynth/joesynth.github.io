...
https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Google_Adsense_logo.png/1024px-Google_Adsense_logo.png



Donos de websites podem inscrever-se no programa para exibir anúncios em texto, imagem, vídeo. A exibição dos anúncios é administrada pela Google e gera lucro baseado na quantidade de cliques ou de visualizações.

Aqueles que quiserem anúnciar no Google podem inscrever-se através do Google Adwords, o Adwords é a fonte de toda a renda do AdSense. 
