...
Brincando com esse trio de linguagens logo logo conhecerá ainda mais tecnologias, como softwares [CLI](/o-que-e-cli) ou mesmo [repositórios](/repositorio-o-que-e).

### Aplicações

###### Site

<img src="https://joesynth.files.wordpress.com/2020/04/596a.png" alt="Estúdio 596 (±2006)" width="120" /> Por volta do ano 2000 criei o site <del>estudio596.com</del>, escrito inteiramente com HTML e CSS. Ele foi o pré-cursor do atual blog [JoeSynth](/joesynth.wordpress). 
...
<img src="https://user-images.githubusercontent.com/20995835/33467021-cc041d9c-d638-11e7-9697-ee8c6706d89b.png" width="120" /> Outra aplicação é fazer jogos, ou mesmo criar uma animação,fazer um 'robô" falar. Veja o caso dessa "simpática aula" sobre o <a href="https://www.youtube.com/watch?v=-VN6phOf4hY">Editor Bluefish</a>, ministrada por um robozinho!
...
###### Interpretador
HTML é uma linguagem do tipo interpretada. O Firefox, o software navegador (browser), é que faz esse trabalho de interpretar o código HTML, exibindo ao usuário.
...
🔗️ whatwg.org.
<h6>Variedade de tags</h6>
Veja <a href="https://joesynth.wordpress.com/2021/04/13/primeiras-nocoes-e-texto/">primeiras noções e texto</a>.
<h6>Pré-requisitos para aprender HTML</h6>
...
🔗️developer.mozilla.org/en-US/docs/Web/JavaScript  
...
É essencial conhecer HTML, e mesmo CSS é bem-vindo. Lembrando que HTML e CSS são a base da internet.
...
Bela história e introdução na web:
    https://youtu.be/YoDJsSII2Ug [bela história e introdução]


<h6>Versões</h6>

    HTML5 [2014].</li>
    XHTML [2000] (que é baseada em <a href="https://joesynth.wordpress.com/2021/12/27/linguagens-resumo/">XML</a>).</li>
    HTML4 [99].</li>


<h6>HTML - XML - XHTML: as diferenças</h6>
