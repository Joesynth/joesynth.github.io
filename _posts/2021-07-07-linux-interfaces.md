...
No Linux, como o computador é nosso de fato, temos a liberdade de escolher a interface mais apropriada _por ex., uma mais leve para um PC antigo ou uma mais formal para o computador da empresa. Há vários contextos sobre isso!
...
> "No GNU/Linux, diferente do Windows, existe a possibilidade dos usuários escolherem as interfaces gráficas." <em>[AMAN, 2018] </em>
