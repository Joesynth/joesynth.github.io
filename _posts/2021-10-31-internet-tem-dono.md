...
Não é difícil lermos, ou ouvirmos dizer, que a Web não é de ninguém ou que ela é pública, etc.

Certa vez, brincando, disse um repentista numa música:
"_Pai é quem cria".

E é bem por aí! Vamos aqui "dar nome aos bois" e conhecer melhor quem está "por trás" da maior tecnologia de comunicação atual: a Internet.
...
<img class="alignleft" src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/ed/W3C%C2%AE_Icon.svg/330px-W3C%C2%AE_Icon.svg.png" width="49px" />

🇺🇸 <strong>W3C</strong>: Famosa entre desenvolvedores de sites, a norte-americana W3C é a organização que visa padronizar a WWW.
A W3C remonta a própria história da internet ou da computação, estando intimamente ligada a nomes como Berners-Lee e o MIT. Várias linguagens de computador são abordadas pela W3C, como a CSS e a XML.
O "QG" fica nos EUA, mas também há escritórios na França, Japão e China.

Claro que para tudo isso funcionar é necessário sistemas operacionais.
Portanto vale a pena ler "<a href="https://joesynth.wordpress.com/2021/10/30/gigantes-da-tecnologia-sistemas-operacionais/">Gigantes da Tecnologia: Sistemas Operacionais</a>".

É isso!  
\o/  

<!--
Internet IPv4, IANA, g1.globo.com
IANA,ICANN, ufes.br
-->
