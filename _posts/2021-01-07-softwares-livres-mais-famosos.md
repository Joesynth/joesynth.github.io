...
Os *softwares* que todos deveríamos utilizar, simplesmente por serem livres de fato.
...
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Thunderbird_Logo%2C_2018.svg/250px-Thunderbird_Logo%2C_2018.svg.png" width="120" />Cliente de e-mail, semelhante ao *email* do Yahoo, por exemplo, porém é instalado no seu computador. 
...
Um *media player* muito conhecido por recursos de *streaming*. É possível transmitir vídeos do VLC Media Player para a sua TV.  
...
⬇️ Ubuntu Software.  
🖥️ Linux, Mac, Windows.  
📜️ GPL (Cliente) 🔒️ Proprietário (Servidor).  
...
Veja [DAW softwares grátis](https://joesynth.wordpress.com/2021/11/13/daw-software-gratis/), um artigo do *blog* JoeSynth Wordpress.  

###### Educação

👉️ Veja [77 softwares educacionais livres](/softwares-educacionais-livres).  

###### Empresa/escritório

👉️ Leia [Software de gestão empresarial](/software-de-gestao-empresarial).
