...
📚 UI: Design de Interface do Usuário (User Interface Design).  
📚 UX (User Experience): Experiência do Usuário.  

|UI|UX|
|:---:|:---:|
|Meio pelo qual o usuário interage e controla um dispositivo.|O chamado UX Design está associado com a experiência (e sentimentos) do usuário, que será alcançada com a UI|
|🎛️<br />(botões, menus etc)|😀|

🤔 O tema parece simples, mas não é. É um poderoso recurso das empresas para influenciarem (ou até dominarem) os usuários.

Vide [UI e UX](/ui-e-ux).
...
<h4>🐧 Software Livre &amp; Software Privado</h4>
...
<h4>👁️ Vigiar, monitorar, controlar</h4>
...
👆 Num app ou site, quando clicamos num botão qualquer esse acontecimento é capturado pelo sistema. Chamado de evento (event) ele pode, por exemplo, dizer ao dono do sistema quantas vezes um usuário clicou nesse botão (sem que o usuário sequer fique sabendo disso). Não só botões, mas ícones, imagens e outros tipos de 'objetos' podem ter eventos associados.
