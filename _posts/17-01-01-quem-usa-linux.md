...
> “O Exército adotou o plano de migração para [software livre](/software-livre-e-software-proprietario) e dentre as inúmeras recomendações uma delas é a utilização do [Ubuntu](/linux) para os desktops, pois é desenvolvido com base no Debian, já alcançou certo grau de maturidade e é de fácil utilização.” [AMAN, 2018]
...
**Os 13 servidores**: os chamados [13 servidores](/internet-tem-dono) são computadores centrais da internet, a maioria absoluta nos EUA. Utilizam um *software* principal, o BIND, que é exatamente para sistemas Linux.  
...
🤔 Além de estar usando sem saber, também não tem os reais benefícios do Linux _inclusive a autonomia, que neste caso específico é da Google. Vide [Por Que Usar Linux?](/por-que-usar-linux).
...
A princípio, esses são os motivos. Entretanto a questão não termina aí, pois sendo um [software livre](/software-livre-e-software-proprietario), qualquer cidadão poderia estar usufruindo.  

Nos exemplos que listamos, muitos Linux são versões para *desktop*; ou seja, o tipo de computador doméstico utilizado por uma pessoa comum. Vide [Ubuntu](/linux).  

🤔 A pergunta central: *"por que **você** não usa Linux?"*, vista que ele é o suprassumo dos sistemas, e custa **R$0,00**.  

Clique no link [Por que Usar Linux?](/por-que-usar-linux) e entenda o motivo pelo qual faz com que só "os grandões" usem o Linux e o cidadão não.  
